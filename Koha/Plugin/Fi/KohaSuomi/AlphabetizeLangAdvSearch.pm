package Koha::Plugin::Fi::KohaSuomi::AlphabetizeLangAdvSearch;
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/AlphabetizeLangAdvSearch/";
